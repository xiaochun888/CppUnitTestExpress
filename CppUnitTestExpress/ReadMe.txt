========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet CppUnitTestExpress
========================================================================

AppWizard a créé cette application CppUnitTestExpress pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application CppUnitTestExpress.


CppUnitTestExpress.vcxproj
...
CppUnitTestExpress.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) CppUnitTestExpress.pch et un fichier de type précompilé nommé StdAfx.obj.
