# CppUnitTestExpress
 ...
 It is just a versy small header file but uses the C/C++ features (X marco, template specialization and recursive, ...) to simplify test work, it has only one assert tool in template to do all test cases and to save your leaning time.
